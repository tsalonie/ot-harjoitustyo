...
Sovelluksen avulla käyttäjien on mahdollista luoda pieniä wikiartikkeleita, joissa on tekstiä ja linkkejä. Sovellukseen voi rekisteröityä useita käyttäjiä, jotka voivat editoida omia artikkeleitaan, sekä laajat editointioikeudet omaava pääkäyttäjä.
...
Kirjautumisen jälkeen käyttäjä voi valita listasta artikkelin, jota haluaa editoida
Jos artikkeli ei ole käyttäjän oma, järjestelmä ei anna editoida sitä
...
Käyttäjä voi lukea toisen käyttäjän artikkelia
